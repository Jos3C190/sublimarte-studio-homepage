        ...
        {videoUrl ? (
          <div className="absolute inset-0 pointer-events-none select-none motion-reduce:hidden">
            <video
              ...
              style={videoStyle}
              className={`${videoClassName} transition-opacity duration-1000 ${videoReady ? 'opacity-30 sm:opacity-15 md:opacity-15 lg:opacity-30 xl:opacity-30 2xl:opacity-30' : 'opacity-30'
                }`}
            />
